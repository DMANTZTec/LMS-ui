...
// console.log("authed,role,dashpathPath are: ",authed,role,dashboardPath);
//     return (
...
const Header = () => {
    ...
    const dashboardPath =
        role === 'STUDENT' ? '/student-dashboard' : role === 'INSTRUCTOR' ? '/Instructor-dashboard' : '/Staff-dashboard';

useEffect(() => {
//console.log("authed,role,dashpathPath are in useEffect: ",authed,role,dashboardPath);
},[]);
